...
class AdminAsset extends AssetBundle
{
    ...
    public $baseUrl = '@web';
    public $css = [ // Переносим стили из шаблона admin
    ...
    public $js = [ // Переносим скрипты из шаблона admin
        //'bower_components/jquery/dist/jquery.min.js',  // jquery будет подключаться автоматом, поэтому мы не переносим его из шаблона admin
