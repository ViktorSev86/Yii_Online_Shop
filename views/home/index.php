...
<!-- /banner -->	
	...
	<!-- top-brands -->
		<?php if(!empty($offers)): // Добавляем условие вывода данного блока: выводим, если есть товары с is_offer == 1 ?>
											...
											<figure>
												<div class="snipcart-item block" >
													<div class="snipcart-thumb">
														...
														<h4>
															<?= $offer->price ?>
															<?php if((float) $offer->old_price): // Поскольку old_price передаётся как строка '0.00', преобразуем её к float типу, чтобы если старая цена не указана (при значении 0.0), она и не выводилась ?>
